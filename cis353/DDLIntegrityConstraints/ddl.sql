...
*/
CONSTRAINT IC2 CHECK ((NOT (priority IN ('high'))) OR (NOT(cost < 2000))),
/*
IC3: The cost of a medium priority order is between 800 and 2200 (inclusive).
*/
CONSTRAINT IC3 CHECK ((NOT (priority IN ('medium'))) OR ((800 <= cost AND cost <= 2200))),
/*
IC4: The cost of a low priority order is less than 1000.
*/
CONSTRAINT IC4 CHECK ((NOT (priority IN ('low'))) OR ((cost < 1000)))
);
--
--
