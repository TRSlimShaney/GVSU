 ...
 * 
 * Eleven static fields are included for navigation in eleven specific directions.
 * These eleven directions can also be identified by index into the given static
 * DIRECTION array.
 * 
...
public class Cube {
	...
	/*******************************************************************
	 * Cube constructor initializes the location fields:
	 *          row, column, depth.
	 * 
	 * @param r
	 * @param c
   ...
   public Cube( int r, int c, int d )
	...
	/****************************************************************
	 * The reset method resets the row, column, depth fields with the
	 * r, c, d parameter values for a new position, perhaps on some 
	 * game board.
	 * 
	 * @param r
	 * @param c
	...
	/*******************************************************************************
	 * The navigate method changes this cube by adding to its row and column 
	 * fields the values of the row, column, depth fields of the change square,
	 * respectively.
	 * 
	 * @param change
	 ********************************************************************************/
